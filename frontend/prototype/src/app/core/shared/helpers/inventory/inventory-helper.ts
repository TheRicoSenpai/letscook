...
export class InventoryHelper {
    ...
    static addIngredient(inventory: Ingredient[], ing: Ingredient): boolean{
      ...
      static removeIngredient(inventory: Ingredient[], ing: Ingredient): boolean{
      ...
      static reduceIngredients(inventory: Ingredient[], ing: Ingredient): boolean{
        if (ing && inventory.some(i => i.type === ing.type && i.foodType === ing.foodType)){
